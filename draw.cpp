...
void draw_main_ship(int x, int y)
{
    ...
    glPushMatrix();
        glTranslated(45,-height*.4+10,0);
        glColor3f(185.0/255.0, 185.0/255, 185.0/255);
        glPolygonMode(GL_FRONT_AND_BACK,GL_FILL);
        glPushMatrix();
            glTranslated(0,height/2,0);
            glBegin(GL_POLYGON);
            for(double i = 0; i < 2 * PI; i += PI / 360)
                glVertex2f(cos(i) * 40, sin(i) * 40);
            glEnd();
        glPopMatrix();
        glColor3f(0,0,0);
        glPushMatrix();
        ...
        glPushMatrix();
            ...
            glEnd();
            glBegin(GL_QUADS);
                glVertex2d(-20.0,-65.0);
                glVertex2d(20.0,-65.0);
                glVertex2d(20.0, -75.0);
                glVertex2d(-20.0,-75.0);
            glEnd();
            glBegin(GL_QUADS);
                glVertex2d(-30.0,-50.0);
                glVertex2d(-20.0,-50.0);
                glVertex2d(-20.0, -120.0);
                glVertex2d(-30.0,-120.0);
            glEnd();
            glBegin(GL_QUADS);
                glVertex2d(20.0,-50.0);
                glVertex2d(30.0,-50.0);
